...
const batchAPath = 'scratch/batch1_a.json';
const batchBPath = 'scratch/batch1_b.json';
...
console.log('Original companies count:', originalData.length);
...
function mergeFile(filePath) {
  ...
  data.forEach(c => {
    // If the company already exists, merge it or overwrite it
