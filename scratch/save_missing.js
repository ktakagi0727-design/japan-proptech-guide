...
fs.writeFileSync('scratch/missing_companies.json', JSON.stringify(missing, null, 2), 'utf8');
console.log('Successfully wrote missing_companies.json. Total missing:', missing.length);
